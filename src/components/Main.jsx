...
function Main() {
  ...
  const imageMy =
    "https://live.staticflickr.com/65535/53301921526_f431ee79f9_w.jpg";
  return (
    <div className="main flex justify-between pt-10  md:pt-44 pb-96 md:pb-10  pl-[12%] pr-[23%] ">
      ...
      <div className="middle absolute top-80 md:top-0 md:relative  grid gap-4 font-semibold w-80  ">
        <h1 className=" text-[40px] md:text-[46px] font-semibold whitespace-nowrap text-black">
          Hi, I'm Bhuwan
        </h1>
        <h3 className="flex text-xl  md:text-2xl ">
          Creative{" "}
          <span className="ml-1 text-text-color">
            {" "}
            <Typewriter
              options={{
        ...
        <p className=" text-base md:text-lg">
          I’m a front-end developer specializing in the ReactJS ecosystem
        </p>

        <button
          className="flex items-center justify-between bg-button-color w-36 px-3 font-semibold py-4 rounded-lg   transition-all  hover:text-black"
          onClick={() => handleWhatsAppClick("+977 9861658435")}
        >
        ...
        <Link to="about" smooth>
          <div className="scroll hidden md:flex items-center pt-10 animate-bounce cursor-pointer transition-all">
