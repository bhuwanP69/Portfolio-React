  ...
  <div className="about grid justify-center pt-16 " id='about'>
    ...
    <div className="a-bottom mt-10 grid sm:flex justify-between pr-5 pl-20 md:pl-0">
        ...
        <div className="a-right  w-[360px]">
            <p className='mb-5 text-[16px] '>With over 4+ years experience in building professional websites for businesses, brands and individuals, I bring you closer to your customers with my developer + SEO skills.</p>
            ...
            <div className="numbers my-8 -ml-4 flex text-sm text-center">
                <p className='w-24 '> <span className='block text-2xl font-semibold text-black'>04+</span> Years experience</p>
                <p className='w-24'> <span className='block text-2xl font-semibold text-black'>27+</span> 
                Completed Project</p>
                <p className='w-24'> <span className='block text-2xl font-semibold text-black'>04+</span>Helped Companies</p>
